...
The regression pipeline built later fixes this with line-stratified GroupKFold cross-validation, where no fly from a given line ever appears in both train and test folds. See `05_perfly_evaluation.md` for details.
